            ...
            if (_keyfile.Equals(""))
            {
                ...
                foreach (var computer in _computername)
                {
                    ...
                    if (_proxyserver != "")
                    {
                        ...
                        {
                            WriteVerbose("Connecting via a unauthenticated proxy.");
                        ...
                        {
                            WriteVerbose("Connecting via a authenticated proxy.");
                            connectInfo = new ConnectionInfo(computer,
                                _port,
                                _credential.GetNetworkCredential().UserName,
                                ptype,
                    ...
                    WriteDebug("Creating handler in the case of keyboard interactive.");
                    ...
                    WriteDebug("Initiating connection object.");
